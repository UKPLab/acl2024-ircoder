...
class SupervisedDataset(Dataset):
    ...
    def __init__(
        ...
        targets = [f"{example['message']}{tokenizer.eos_token}" for example in dataset]
...
def train():
    ...
    data_module, predict_dataset = make_supervised_data_module(tokenizer=tokenizer, data_args=data_args, model_args=model_args)
    trainer = Trainer(
        model=model, 
        tokenizer=tokenizer,
